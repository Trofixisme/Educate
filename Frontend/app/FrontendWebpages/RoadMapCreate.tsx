...
// import { ClientOnly } from "./fragments/ClientOnly";
...
export default function RoadMapCreate() {
    ...
    function addSkill(moduleIndex: number) {
    ...
    function removeSkill(moduleIndex: number, skillIndex: number) {
        const updated = modules.map((mod, i) => {
            if (i !== moduleIndex) return mod;
        ...
        async function handleSubmit(e: FormEvent<HTMLFormElement>) {
            ...
            const body = {
                ...
                roadmapModules: modules.map((mod, moduleIndex) => ({
                    ...
                    skills: mod.skills.map((_, skillIndex) => ({
                        ...
                        resourceLinks: [formData.get(`modules[${moduleIndex}].skills[${skillIndex}].links[0]`)]
                    }))
                }))
            };
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex gap-3">
                                                <Button type="button" onPress={() => addSkill(moduleIndex)} variant="tertiary" isIconOnly>
                                                    <img className="chip_icon w-3" src="/images/assets/plus-black@4x.png" alt="add skill"/>
                                                </Button>
