...
public interface JobRepo extends JpaRepository<JobPosting, Long> {
    List<JobPosting> findJobPostingByJobNameOrderByDatePostedDesc(String jobName);

    JobPosting findJobPostingById(Long id);

    List<JobPosting> findJobPostingByRecruiterIdOrderByDatePostedDesc(Long recruiterId);
    ...
    List<JobPosting> findAllByOrderByDatePostedDesc();
